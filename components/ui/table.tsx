...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'border-b border-b-zinc-100 transition-colors hover:bg-zinc-100/50',
      'data-[state=selected]:bg-zinc-100',
      'dark:border-b-zinc-800 dark:hover:bg-zinc-800/50 dark:data-[state=selected]:bg-zinc-800',
      className
    )}
    {...props}
  />
